...
import argparse
import os
from third_party.omnimatte.third_party.util import util
from third_party.omnimatte.third_party import models
from third_party.omnimatte.third_party import data
import torch
import json
...
class BaseOptions():
    ...
    def gather_options(self, argv):
        ...
        opt, _ = parser.parse_known_args(argv)  # parse again with new defaults
