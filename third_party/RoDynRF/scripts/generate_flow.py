...
def load_image(imfile):
    img = np.array(Image.open(imfile))[..., :3].astype(np.uint8)
...
if __name__ == '__main__':
    ...
    output_path = os.path.join(args.dataset_path, 'train_rodynrf/flow')
    output_img_path = os.path.join(args.dataset_path, 'train_rodynrf/flow_png')
